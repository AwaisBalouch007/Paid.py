...
logo = "'\x1b[1;92m'   \n'\x1b[1;92m'\n'\x1b[1;91m'   \n'\x1b[1;97m'     \n'\x1b[1;93m'  \n'\x1b[1;94m'   \n\n'\x1b[1;91m'   Author      :     Awais     \n'\x1b[1;92m'   Github      :      \n'\x1b[1;93m'   FB ID       :     N/A\n'\x1b[1;94m'   TOOL TYPE   :     PAID COMMANDS\n'\x1b[1;96m'   WAP NUMBER  :     03097156348            \n"
dec = '2'
server = '2'
...
def main_apv():
    ...
    try:
        ...
        os.system('xdg-open https://wa.me/+923097156348')

    r1 = requests.get('https://github.com/AwaisBalouch007/Paid.py/blob/main/server.txt .').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
...
def main_input():
    ...
    if mx == '1':
        ...
        print '\x1b[1;92m        Member In Awais Paid Commands '
        ...
        os.system('git clone
https://github.com/AwaisBalouch007/Paid.py')
